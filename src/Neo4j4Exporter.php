 ...
 */
class Neo4j4Exporter extends Exporter {

  /** Used format -- defaults to Neo4J */
  private $format = self::NEO4J4_FORMAT;
   ...
   */
  public function __construct( $format = self::NEO4J4_FORMAT, $nodefile = self::NODE_FILE, $relfile = self::REL_FILE, $startcount = 0) {
  ...
  protected function quote_and_escape( $str) : string {
	...
	// admin-import hates \" inside strings as escaping char
    $str = "\"".str_replace( "\"", "'", $str)."\"";
